...
const navigate= useNavigate()
  ...
  const handleSubmit = async(e)=>{
    e.preventDefault()
    setloader(true)
    const {product_title,product_category,product_desc,product_qty,product_price,productImage} = formData
    const res = await addProduct(product_title,product_category,product_desc,product_qty,product_price,productImage)
    if(res.success){
      setTimeout(() => {
